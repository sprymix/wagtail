...
urlpatterns = [
    ...
    url(r'^(\d+)/generate_url/$', images.url_generator,
        name='wagtailimages_url_generator'),
    url(r'^(\d+)/generate_url/(.*)/$', images.generate_url,
        name='wagtailimages_generate_url'),
    ...
    url(r'^multiple/(\d+)/$', multiple.edit,
        name='wagtailimages_edit_multiple'),
    url(r'^multiple/(\d+)/delete/$', multiple.delete,
        name='wagtailimages_delete_multiple'),

    url(r'^chooser/$', chooser.chooser, name='wagtailimages_chooser'),
    url(r'^chooser/(\d+)/$', chooser.image_chosen,
        name='wagtailimages_image_chosen'),
    url(r'^chooser/upload/$', chooser.chooser_upload,
        name='wagtailimages_chooser_upload'),
    url(r'^chooser/(\d+)/select/$', chooser.chooser_select,
        name='wagtailimages_chooser_select'),
    url(r'^chooser/(\d+)/select_format/$', chooser.chooser_select_format,
        name='wagtailimages_chooser_select_format'),
    url(r'^chooser/(\d+)/select_rendition/$', chooser.chooser_select_rendition,
        name='wagtailimages_chooser_select_rendition'),
]
