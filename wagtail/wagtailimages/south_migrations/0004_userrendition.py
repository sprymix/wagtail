...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserRendition.focal_point_key'
        db.add_column('wagtailimages_userrendition', 'focal_point_key',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserRendition.focal_point_key'
        db.delete_column('wagtailimages_userrendition', 'focal_point_key')
