...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserRendition'
        db.create_table(u'wagtailimages_userrendition', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_renditions', to=orm['wagtailimages.Image'])),
        ))
        db.send_create_signal(u'wagtailimages', ['UserRendition'])


    def backwards(self, orm):
        # Deleting model 'UserRendition'
        db.delete_table(u'wagtailimages_userrendition')
    ...
    models = {
        ...
        u'wagtailimages.userrendition': {
            'Meta': {'object_name': 'UserRendition'},
            'file': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'filter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['wagtailimages.Filter']"}),
            'height': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
