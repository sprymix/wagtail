...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='image',
            name='file',
            field=models.ImageField(upload_to=wagtail.images.models.get_upload_to, height_field='height', width_field='width', verbose_name='file'),
        ),
        migrations.AlterField(
            model_name='image',
            name='height',
        ...
        migrations.AlterField(
            model_name='image',
            name='tags',
            field=taggit.managers.TaggableManager(through='taggit.TaggedItem', verbose_name='tags', blank=True, help_text='To enter multi-word tags, use double quotes: "some tag".', to='taggit.Tag'),
        ),
        migrations.AlterField(
            model_name='image',
            name='title',
